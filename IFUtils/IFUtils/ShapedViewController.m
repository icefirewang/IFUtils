...
- (void)viewDidLoad {
    ...
    [view if_setContentImage:[UIImage imageNamed:@"64.jpg"]];
    ...
    [view2 if_setContentImage:[UIImage imageNamed:@"64.jpg"]];
    ...
    [btn if_setContentImage:[UIImage imageNamed:@"64.jpg"]];
    ...
    [iv if_setContentImage:[UIImage imageNamed:@"64.jpg"]];
